    ...
    const items = await page.evaluate(() => {
        ...
        itemNodes.forEach((node) => {
            ...
            const degree = node
                ...
                #list > div > div > ul > li:nth-child(1) > div.body > div.info > dl > dd:nth-child(4)
            const speciali = node
                .querySelector("#list .content>ul>li .body .info .brief dd::nth-child(4) ")
                .innerText.trim();
            ...
            itemList.push({ name, degree, speciali, position, introduce });
        });
