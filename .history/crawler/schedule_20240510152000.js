        ...
        .on('data', async (row) => {
            try {
                ...
                await db.Doctor.update({
                    fullName: degree, // Thay thế "fullName" bằng tên cột tương ứng trong cơ sở dữ liệu
                    introduce: introduce
                });
                await db.Position.update({
                    value: position, // Thay thế "fullName" bằng tên cột tương ứng trong cơ sở dữ liệu
                });
