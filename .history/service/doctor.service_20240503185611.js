    ...
    "messages": [
        {
            ...
            "from": "ServiceSMS",
            "text": "Your OTP code is: 123456" // Thay đổi nội dung tin nhắn ở đây
        }
    ]
});

axios.post('https://3gmyqw.api.infobip.com/sms/2/text/otp', data, { headers })
    .then((response) => {
